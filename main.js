document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Khushbu"; // Replace with dynamic value
    ...
    function revealChoices() {
        ...
        setTimeout(() => {
            typeWriterEffect(typedTextElement, "Will you forgive me for Everything?");
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">I love you baby ❤️ Now, That you have forgiven me, I have few things to say. I know tune mere se bohot expectations rakhi thi, jo maine meet nahi kiya. Almost ek month se apne baat nahi ki acchese, block hone ke baad bhi maine koi real effort nahi dikhaya aur tujhe woh care ya respect feel nahi karaya jo tu deserve karti hai. Ab main apni consistency aur presence sabit karna chahta hu, har roz patience rakhunga, genuine attention dunga aur har moment tujhe meri priority banaunga, taki tu khud mehsoos kar sake ki tu meri life ki sabse important insaan hai.Promise ab se meri har effort 11100000% hogi, na frustration ko ek chance milegi, na koi ulta reaction — from today on, teri khushi hi meri sabse badi priority hogi.</span>`;
